                                                ...
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                    ...
                                                    <div class="space-y-4">
                                                        <h1 class="text-4xl fw-800"
                                                            ...
                                                            align="left">Thanks for your order, {{ $data['name'] }}
                                                        </h1>
                                                                ...
                                                                <tr>
                                                                    <td style="line-height: 24px; font-size: 16px; border-radius: 9999px; width: 192px; margin: 0;"
                                                                        ...
                                                                        <a href="https://app.bootstrapemail.com/templates"
                                                                            style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 9999px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #dc3545; padding: 8px 24px; border: 1px solid #dc3545;">Track
                                                                            Your Order</a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 24px; margin: 0; padding: 40px;"
                                                                    ...
                                                                    {{-- <h3 class="text-center"
                                                                        style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;"
                                                                        align="center">Detail order</h3>
                                                                    <table class="p-2 w-full table" border="0"
                                                                        cellpadding="0" cellspacing="0"
                                                                        style="width: 100%;" width="100%">
                                                                        <thead>
                                                                            <tr>
                                                                    ...
                                                                    <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                                        align="left">If
                                                                        you have any questions, contact us at <a
                                                                            href="https://bootstrapemail.com"
                                                                            style="color: #0d6efd;"><span
                                                                                class="__cf_email__"
                                                                                data-cfemail="024a6b72416d707242677a636f726e672c616d6f">[email&#160;protected]</span></a>.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
