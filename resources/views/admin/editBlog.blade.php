                    ...
                    <form action=" {{ url('/admin/blog/' . $blog->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-9">
                            <div class="profile-img">
                                <img class="img_avatar" src="{{ asset('/upload/admin/blog/img_thum/' . $blog->image) }}"
                                    alt="" />
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="example-textarea" rows="5" name="description">{{ $blog->description }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="content" name="content" rows="10" cols="72">{{ $blog->content }}</textarea>
                            </div>
                            @error('content')
                                <p style="color: red;">{{ $message }}</p>
                            @enderror
                        ...
                        <button class="btn btn-danger mb-3" type="submit">EDIT</button>
                    </form>
                </div> <!-- end card-body-->
            </div> <!-- end card-->
        </div> <!-- end col -->
